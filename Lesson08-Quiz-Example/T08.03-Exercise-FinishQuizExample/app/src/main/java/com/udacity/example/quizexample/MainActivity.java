...
public class MainActivity extends AppCompatActivity {
    ...
    // The data from the DroidTermsExample content provider and column variables
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDisplayedWord = (TextView) findViewById(R.id.text_view_word);
    ...
    public void nextWord () {
        ...
        mDisplayedWord.setText(mData.getString(mWordCol));
        mDescription.setText(mData.getString(mDefCol));
    ...
    public class WordFetchTask extends AsyncTask<Void, Void, Cursor> {
        ...
        protected Cursor doInBackground(Void... params) {
            ...
            //force delay to test code in nextWord that doesn't run code if Cursor hasn't been created
/*
            try
            {
                Thread.sleep(2000);
                Log.v("TAG", "Sleeping TRY, 2000 millis");
            }
            catch(InterruptedException ex)
            {
                Log.v("Tag","SLEEP ERROR CAUGHT");
