...
public class VisualizerActivity extends AppCompatActivity {
    ...
    private void setupSharedPreferences() {
        ...
        String bassKey = Integer.toString(R.string.pref_show_bass_key);
        String midKey = Integer.toString(R.string.pref_show_mid_key);
        String trebleKey = Integer.toString(R.string.pref_show_treble_key);
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(this);
        boolean showBass = sharedPreferences.getBoolean(bassKey, false);
        boolean showMid = sharedPreferences.getBoolean(midKey, false);
        boolean showTreble = sharedPreferences.getBoolean(trebleKey, false);
        mVisualizerView.setShowBass(showBass);
        mVisualizerView.setShowMid(showMid);
        mVisualizerView.setShowTreble(showTreble);
        mVisualizerView.setMinSizeScale(1);
